            ...
            <div class="ibox-content">
                ...
                <form action="<%=basePath%>/admin/download/add" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control m-b" name="platformtype">
                                <option value="0" ${form.platformtype=='0'?'selected':''} >X86</option>
                                ...
                                <option value="4" ${form.platformtype=='4'?'selected':''} >龙芯<em>(敬请期待)</em></option>
                                <option value="5" ${form.platformtype=='5'?'selected':''} >X64</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <label><input name="productversion" type="radio" value="0" ${form.productversion=='0' || form.productversion==null?'checked':''} />CRH5.0</label>
                            <label><input name="productversion" type="radio" value="1" ${form.productversion=='1'?'checked':''} />CRH4.9</label>
                            <label><input name="productversion" type="radio" value="2" ${form.productversion=='2'?'checked':''} />TensorFlow</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">操作系统编号</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <label><input name="documenttype" type="radio" value="0" ${form.documenttype=='0' || form.documenttype==null?'checked':''} />发布(显示)</label>
                            <label><input name="documenttype" type="radio" value="1" ${form.documenttype=='1'?'checked':''} />不发布(不显示)</label>
                        </div>
                    </div>


                   <%-- <div class="form-group">
                        <label class="col-sm-2 control-label">此版本支持的系统 :</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">此版本支持的芯片 :</label>
                        <div class="col-sm-4">
