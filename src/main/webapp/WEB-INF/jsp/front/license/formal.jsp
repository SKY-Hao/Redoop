                    ...
                    <form action="<%=basePath%>/front/license/register" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <span class="help-block m-b-none">申请正式许可的公司名称&nbsp;&nbsp;<b style="color: red;">*</b></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <span class="help-block m-b-none">申请正式许可的项目&nbsp;&nbsp;<b style="color: red;">*</b></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">正式产品</label>
                            <div class="col-sm-10">
                                ...
                                <span class="help-block m-b-none">申请正式产品的版本&nbsp;&nbsp;<b style="color: red;">*</b></span>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label">正式节点</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="node" value="${form.node}" id="node" placeholder="默认为3个节点">
                                <span class="help-block m-b-none">申请正式节点数</span>
                            </div>
                        </div>
